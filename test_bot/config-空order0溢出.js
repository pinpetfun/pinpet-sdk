...
const CONFIG = {
  ...
  tradingPlan: [
    ...
    { 
      type: 'buy', 
      enabled: true, 
      description: '买入80000000000000个代币',
      params: {
        buyTokenAmount: '80000000000000',  // 100,000 tokens (精度 10^6)
        maxSolAmount: '50000000000'       // 最多花费5 SOL
      }
    },
    ...
    { 
      type: 'sell', 
      enabled: true, 
      description: '卖出180000000000000个代币',
      params: {
        sellTokenAmount: '180000000000000',  // 50,000 tokens
